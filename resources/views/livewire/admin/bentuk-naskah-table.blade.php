<div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md">
    ...
    <div class="mt-6 flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-4 sm:space-y-0">
        <div class="relative w-full sm:w-1/3">
            ...
            <x-input type="text" wire:model.debounce.300ms="search" placeholder="Cari bentuk naskah..." class="pl-10 w-full" />
        </div>
        
        <div class="w-full sm:w-auto">
            <a href="{{ route('admin.bentuk-naskah.create') }}" 
                ...
                @forelse ($items as $item)
                    <tr class="odd:bg-white even:bg-gray-50 align-middle">
                        ...
                        <td class="px-4 py-3 text-sm font-medium text-gray-900 whitespace-normal break-words">
                            {{ $item->nama_bentuk_naskah }}
                        </td>
                        <td class="px-4 py-3 whitespace-nowrap text-center text-sm font-medium">
                            <div class="flex justify-center items-center space-x-4">
                                <a href="{{ route('admin.bentuk-naskah.edit', $item->id) }}" title="Edit" class="text-gray-500 hover:text-indigo-600">
