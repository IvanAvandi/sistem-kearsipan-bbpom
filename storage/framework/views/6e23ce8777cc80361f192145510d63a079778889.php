...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['type' => 'text','wire:model.debounce.300ms' => 'search','placeholder' => 'Cari nama atau URL...','class' => 'pl-10 w-full']]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'text','wire:model.debounce.300ms' => 'search','placeholder' => 'Cari nama atau URL...','class' => 'pl-10 w-full']); ?>
...
<?php endif; ?>
        ...
        <div class="w-full sm:w-auto">
            <a href="<?php echo e(route('admin.link-terkait.create')); ?>" 
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="odd:bg-white even:bg-gray-50 align-middle">
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-700"><?php echo e($loop->iteration + $items->firstItem() - 1); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                            <?php if($item->path_icon): ?>
                                <img src="<?php echo e(Storage::url($item->path_icon)); ?>" alt="ikon" class="h-10 w-10 object-cover rounded-md">
                            <?php else: ?>
                                -
                            <?php endif; ?>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                            <a href="<?php echo e($item->link_url); ?>" target="_blank" class="text-blue-500 hover:underline" title="<?php echo e($item->link_url); ?>">
                                <?php echo e(Str::limit($item->link_url, 40)); ?>

                            </a>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                            <span class="inline-flex justify-center items-center px-2 py-0.5 text-xs leading-5 font-semibold rounded-full w-24 <?php echo e($item->status == 'Aktif' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                           <div class="flex justify-center items-center space-x-4">
                                <a href="<?php echo e(route('admin.link-terkait.edit', $item->id)); ?>" title="Edit" class="text-gray-500 hover:text-indigo-600">
...
</div><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah - Copy\resources\views/livewire/admin/link-terkait-table.blade.php ENDPATH**/ ?>