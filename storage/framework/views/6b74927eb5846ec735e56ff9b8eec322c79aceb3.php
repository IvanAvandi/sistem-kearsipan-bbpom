...
} elseif ($_instance->childHasBeenRendered('APnElxh')) {
    $componentId = $_instance->getRenderedChildComponentId('APnElxh');
    $componentTag = $_instance->getRenderedChildComponentTagName('APnElxh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('APnElxh');
} else {
    $response = \Livewire\Livewire::mount('arsip-table');
    $html = $response->html();
    $_instance->logRenderedChild('APnElxh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php endif; ?><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah - Copy\resources\views/arsip/index.blade.php ENDPATH**/ ?>