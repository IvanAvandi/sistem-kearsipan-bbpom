...
} elseif ($_instance->childHasBeenRendered('tCHkS2d')) {
    $componentId = $_instance->getRenderedChildComponentId('tCHkS2d');
    $componentTag = $_instance->getRenderedChildComponentTagName('tCHkS2d');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tCHkS2d');
} else {
    $response = \Livewire\Livewire::mount('admin.template-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('tCHkS2d', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div></div></div></div>
...
<?php endif; ?><?php /**PATH D:\MAGANG\sistem-kearsipan-bbpom\resources\views/admin/templates/index.blade.php ENDPATH**/ ?>