...
<?php endif; ?>
     <?php $__env->endSlot(); ?>
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.template-table', [])->html();
} elseif ($_instance->childHasBeenRendered('i98T4F0')) {
    $componentId = $_instance->getRenderedChildComponentId('i98T4F0');
    $componentTag = $_instance->getRenderedChildComponentTagName('i98T4F0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('i98T4F0');
} else {
    $response = \Livewire\Livewire::mount('admin.template-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('i98T4F0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div></div></div></div>
...
<?php endif; ?><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah - Copy\resources\views/admin/templates/index.blade.php ENDPATH**/ ?>