                ...
                <form wire:submit.prevent="updateBA" class="mt-5 space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model.defer="nomor_ba" id="nomor_ba_modal" 
                               class="block w-full mt-1 rounded-md shadow-sm sm:text-sm <?php $__errorArgs = ['nomor_ba'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" wire:model.defer="tanggal_ba" id="tanggal_ba_modal" 
                               class="block w-full mt-1 rounded-md shadow-sm sm:text-sm <?php $__errorArgs = ['tanggal_ba'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php else: ?> border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                ...
                                <?php if($usulan->diusulkanOleh): ?>
                                    ...
                                    Diajukan: <span class="font-medium text-gray-700"><?php echo e($usulan->diusulkanOleh?->name ?? 'User Dihapus'); ?></span>
                                    (<?php echo $usulan->diajukan_pada->isoFormat('D MMM Y, HH:mm'); ?>)
                                <?php endif; ?>
                            </p>
                            <div class="mt-4">
            ...
            <?php if(in_array($usulan->status, ['Draft', 'Diajukan', 'Dikembalikan'])): ?>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-4 mb-4">
                            <h3 class="text-lg font-semibold text-gray-900">
                                Daftar Arsip yang Diusulkan (<?php echo e($arsipList->count()); ?> arsip)
                            </h3>
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
                                            <td colspan="<?php echo e(in_array($usulan->status, ['Draft', 'Dikembalikan']) ? '8' : '7'); ?>" class="px-6 py-10 text-center text-sm text-gray-500">
...
<?php $__env->stopPush(); ?><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah - Copy\resources\views/livewire/usulan-pindah-show.blade.php ENDPATH**/ ?>