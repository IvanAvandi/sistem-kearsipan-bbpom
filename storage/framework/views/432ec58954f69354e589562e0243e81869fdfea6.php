...
<?php endif; ?>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-base text-gray-500">
                                Dibuat oleh <span class="font-medium text-gray-700"><?php echo e($usulan->user?->name ?? 'User Dihapus'); ?></span> 
            ...
            <?php elseif($usulan->status == 'Selesai'): ?>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg border">
                                ...
                                <dl class="mt-3 text-sm space-y-2">
                                    <div class="flex justify-between"><dt class="text-gray-500">Nomor:</dt> <dd class="text-gray-800 font-medium text-right"><?php echo e($usulan->nomor_surat_usulan ?? '-'); ?></dd></div>
                                    <div class="flex justify-between"><dt class="text-gray-500">Tanggal:</dt> <dd class="text-gray-800 text-right"><?php echo e($usulan->tanggal_surat_usulan ? $usulan->tanggal_surat_usulan->isoFormat('D MMM Y') : '-'); ?></dd></div>
                                    <?php if($usulan->file_surat_usulan_path): ?>
                                    <div class="pt-2 border-t"><a href="<?php echo e(Storage::url($usulan->file_surat_usulan_path)); ?>" target="_blank" class="text-indigo-600 hover:underline font-medium">Lihat Dokumen &rarr;</a></div>
                                    <?php else: ?>
                                    <div class="pt-2 border-t"><span class="text-gray-500 italic">(Dokumen tidak diupload)</span></div>
                                    <?php endif; ?>
                                </dl>
            ...
            <?php if(!in_array($usulan->status, ['Dibatalkan', 'Ditolak', 'Selesai'])): ?>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        
                        <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-4 mb-4">
                            <h3 class="text-lg font-medium text-gray-900">Daftar Arsip dalam Usulan Ini (<?php echo e($usulan->status == 'Draft' ? $this->arsipList->total() : $usulan->arsips->count()); ?> arsip)</h3>
                            
                            <div class="flex items-center space-x-2">
                                <?php if(count($selectedArsip) > 0 && $usulan->status == 'Draft'): ?>
                                    <button type="button" onclick="konfirmasiHapusArsip()" 
                                        ...
                                        <span wire:loading.remove wire:target="removeSelectedArsips">Hapus Arsip (<?php echo e(count($selectedArsip)); ?>)</span>
                                    </button>
                                <?php endif; ?>
                                <?php if($usulan->status == 'Draft'): ?>
                        ...
                        <div class="mt-4 overflow-x-auto">
                            <table class="min-w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    ?>
                                    <?php $__empty_1 = true; $__currentLoopData = $arsipCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arsip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="align-middle <?php echo e(in_array($arsip->id, $selectedArsip ?? []) ? 'bg-indigo-50' : 'odd:bg-white even:bg-gray-50'); ?>">
                                            ...
                                            <?php endif; ?>
                                            <td class="px-4 py-3 text-center text-sm text-gray-700"><?php echo e($usulan->status == 'Draft' ? $loop->iteration + $arsipList->firstItem() - 1 : $loop->iteration); ?></td>
                                            <td class="px-4 py-3 text-sm text-gray-700"><?php echo e($arsip->klasifikasiSurat()->withTrashed()->first()?->kode_klasifikasi ?? ''); ?></td>
                                            <td class="px-4 py-3 text-sm font-medium text-gray-900"><?php echo e($arsip->uraian_berkas); ?></td>
                                            <td class="px-4 py-3 text-center text-sm text-gray-700"><?php echo e(\Carbon\Carbon::parse($arsip->tanggal_arsip)->isoFormat('D MMMM Y')); ?></td>
                                            <td class="px-4 py-3 text-sm text-center">
                                                <span class="inline-flex justify-center items-center px-3 py-1 text-xs font-medium rounded-full w-36
                                                <?php if($arsip->status == 'Siap Dimusnahkan'): ?> bg-red-100 text-red-800
                                            ...
                                            <td class="px-3 py-3 text-center align-top">
                                                <a href="<?php echo e(route('arsip.show', $arsip->id)); ?>" class="text-gray-500 hover:text-blue-700" title="Lihat Detail Arsip">
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
                                            <td colspan="<?php echo e($usulan->status == 'Draft' ? '8' : '7'); ?>" class="px-6 py-10 text-center text-sm text-gray-500">
                        ...
                        <?php if($usulan->status == 'Draft' && $arsipList->hasPages()): ?>
                        <div class="mt-4">
                            <?php echo e($arsipList->links()); ?>
            ...
            <div class="grid grid-cols-1 <?php if(!in_array($usulan->status, ['Ditolak', 'Dibatalkan', 'Selesai'])): ?> lg:grid-cols-10 <?php endif; ?> gap-6">
                
                
                <?php if($usulan->status != 'Selesai'): ?>
                <div class="<?php if(in_array($usulan->status, ['Draft', 'Diajukan ke Pusat', 'Musnah, Menunggu BA'])): ?> lg:col-span-7 <?php else: ?> lg:col-span-10 <?php endif; ?>">
                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <button wire:click="openUploadSuratModal" class="inline-flex items-center px-4 py-2 bg-yellow-500 border border-transparent rounded-md font-semibold text-sm text-white hover:bg-yellow-600 transition duration-150 ease-in-out">
                                    ...
                                    <?php echo e($usulan->file_surat_usulan_path ? 'Edit Surat Usulan' : 'Lengkapi Surat Usulan'); ?>
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                <dl class="text-sm space-y-3">
                                    <div class="flex justify-between"><dt class="text-sm text-gray-500">Nomor Surat Usulan:</dt> <dd class="text-sm font-medium text-gray-900 text-right"><?php echo e($usulan->nomor_surat_usulan ?? '-'); ?></dd></div>
                                    <div class="flex justify-between"><dt class="text-sm text-gray-500">Tanggal Surat Usulan:</dt> <dd class="text-sm font-medium text-gray-900 text-right"><?php echo e($usulan->tanggal_surat_usulan ? $usulan->tanggal_surat_usulan->isoFormat('D MMM Y') : '-'); ?></dd></div>
                                    <div class="pt-3 border-t border-gray-200">
                                        <?php if($usulan->file_surat_usulan_path): ?>
                                        <a href="<?php echo e(Storage::url($usulan->file_surat_usulan_path)); ?>" target="_blank" class="text-indigo-600 hover:underline font-medium text-sm transition duration-150 ease-in-out">Lihat Dokumen Surat Usulan &rarr;</a>
                                        <?php else: ?>
                ...
                <?php if(!in_array($usulan->status, ['Ditolak', 'Dibatalkan', 'Selesai'])): ?>
                ...
                <form wire:submit.prevent="laksanakanPemusnahan" class="mt-4 space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model.defer="nomor_surat_persetujuan" id="nomor_surat_persetujuan" 
                               class="block w-full mt-1 rounded-md shadow-sm sm:text-sm <?php $__errorArgs = ['nomor_surat_persetujuan'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" wire:model.defer="tanggal_surat_persetujuan" id="tanggal_surat_persetujuan" 
                               class="block w-full mt-1 rounded-md shadow-sm sm:text-sm <?php $__errorArgs = ['tanggal_surat_persetujuan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php else: ?> border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" wire:model.defer="tanggal_pemusnahan_fisik" id="tanggal_pemusnahan_fisik" 
                               class="block w-full mt-1 rounded-md shadow-sm sm:text-sm <?php $__errorArgs = ['tanggal_pemusnahan_fisik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php else: ?> border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php unset($message);
                ...
                <form wire:submit.prevent="arsipkanBapaFinal" class="mt-4 space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model.defer="nomor_bapa_diterima" id="nomor_bapa_diterima" 
                               class="block w-full mt-1 rounded-md shadow-sm sm:text-sm <?php $__errorArgs = ['nomor_bapa_diterima'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php else: ?> border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" wire:model.defer="tanggal_bapa_diterima" id="tanggal_bapa_diterima" 
                               class="block w-full mt-1 rounded-md shadow-sm sm:text-sm <?php $__errorArgs = ['tanggal_bapa_diterima'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php else: ?> border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php unset($message);
                ...
                <form wire:submit.prevent="tolakUsulan" class="mt-4 space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model.defer="nomor_surat_penolakan" 
                               class="block w-full mt-1 rounded-md shadow-sm sm:text-sm <?php $__errorArgs = ['nomor_surat_penolakan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php else: ?> border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" wire:model.defer="tanggal_surat_penolakan" 
                               class="block w-full mt-1 rounded-md shadow-sm sm:text-sm <?php $__errorArgs = ['tanggal_surat_penolakan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php else: ?> border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea wire:model.defer="catatan_penolakan" rows="3" 
                                  class="block w-full mt-1 rounded-md shadow-sm sm:text-sm <?php $__errorArgs = ['catatan_penolakan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php else: ?> border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"></textarea>
    ...
    <div x-data="{ show: <?php if ((object) ('showUploadSuratModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('showUploadSuratModal'->value()); ?>')<?php echo e('showUploadSuratModal'->hasModifier('defer') ? '.defer' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('showUploadSuratModal'); ?>')<?php endif; ?> }" x-show="show" x-cloak class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title-surat" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            <div x-show="show" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75" @click="show = false" aria-hidden="true"></div>
            <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>
            <div x-show="show" x-transition class="inline-block w-full max-w-lg p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-lg">
                ...
                <form wire:submit.prevent="updateSuratUsulan" class="mt-5 space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model.defer="nomor_surat_usulan" id="nomor_surat_usulan_modal" 
                               class="block w-full mt-1 rounded-md shadow-sm sm:text-sm <?php $__errorArgs = ['nomor_surat_usulan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php else: ?> border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        <?php $__errorArgs = ['nomor_surat_usulan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" wire:model.defer="tanggal_surat_usulan" id="tanggal_surat_usulan_modal" 
                               class="block w-full mt-1 rounded-md shadow-sm sm:text-sm <?php $__errorArgs = ['tanggal_surat_usulan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php else: ?> border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        <?php $__errorArgs = ['tanggal_surat_usulan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label for="file_surat_usulan_modal" class="block text-sm font-medium text-gray-700">
                            ...
                            <?php if($usulan->file_surat_usulan_path && !$file_surat_usulan): ?>
                                <a href="<?php echo e(Storage::url($usulan->file_surat_usulan_path)); ?>" target="_blank" class="ml-2 text-xs text-blue-500 hover:underline">(Lihat file terupload)</a>
                            <?php endif; ?>
                        </label>
                        ...
                        <?php $__errorArgs = ['file_surat_usulan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php $__env->stopPush(); ?>
</div><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah - Copy\resources\views/livewire/admin/usulan-pemusnahan-show.blade.php ENDPATH**/ ?>