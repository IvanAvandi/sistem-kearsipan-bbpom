...
<?php
    // Variabel PHP sudah baik, tidak perlu diubah.
    $user = Auth::user();
    $isAdmin = $user->role === 'Admin';

    $selectedDivisiId = old('divisi_id', $arsip->divisi_id ?? ($isAdmin ? null : $user->divisi_id));

    $initialJra = '';
    $selectedKlasId = old('klasifikasi_surat_id', $arsip->klasifikasi_surat_id ?? null);
    if ($selectedKlasId) {
    ...
    $defaultUploadType = old('upload_type', '');
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['id' => 'tanggal_arsip','class' => 'block mt-1 w-full','type' => 'date','name' => 'tanggal_arsip','value' => old('tanggal_arsip', $arsip->tanggal_arsip ?? ''),'required' => true]]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'tanggal_arsip','class' => 'block mt-1 w-full','type' => 'date','name' => 'tanggal_arsip','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('tanggal_arsip', $arsip->tanggal_arsip ?? '')),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.label','data' => ['for' => 'nomor_berkas','value' => 'Nomor Berkas*']]); ?>
<?php $component->withName('label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['for' => 'nomor_berkas','value' => 'Nomor Berkas*']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['id' => 'nomor_berkas','class' => 'block mt-1 w-full','type' => 'text','name' => 'nomor_berkas','value' => old('nomor_berkas', $arsip->nomor_berkas ?? ''),'required' => true]]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'nomor_berkas','class' => 'block mt-1 w-full','type' => 'text','name' => 'nomor_berkas','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('nomor_berkas', $arsip->nomor_berkas ?? '')),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                    <textarea id="uraian_berkas" name="uraian_berkas" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" rows="3" required><?php echo e(old('uraian_berkas', $arsip->uraian_berkas ?? '')); ?></textarea>
                    ...
                    <select name="bentuk_naskah_id" id="select-bentuk-naskah" class="block mt-1 w-full rounded-md shadow-sm border-gray-300">
                        ...
                        <?php $__currentLoopData = $bentuk_naskah_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($bn->id); ?>"
                                <?php echo e(old('bentuk_naskah_id', $arsip->bentuk_naskah_id ?? '') == $bn->id ? 'selected' : ''); ?>>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['id' => 'kurun_waktu','class' => 'block mt-1 w-full','type' => 'text','name' => 'kurun_waktu','value' => old('kurun_waktu', $arsip->kurun_waktu ?? ''),'pattern' => '\d{4}','title' => 'Masukkan tahun (4 digit)','placeholder' => 'YYYY']]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'kurun_waktu','class' => 'block mt-1 w-full','type' => 'text','name' => 'kurun_waktu','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('kurun_waktu', $arsip->kurun_waktu ?? '')),'pattern' => '\d{4}','title' => 'Masukkan tahun (4 digit)','placeholder' => 'YYYY']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['id' => 'jumlah_berkas','class' => 'block mt-1 w-full','type' => 'text','name' => 'jumlah_berkas','value' => old('jumlah_berkas', $arsip->jumlah_berkas ?? '')]]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'jumlah_berkas','class' => 'block mt-1 w-full','type' => 'text','name' => 'jumlah_berkas','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('jumlah_berkas', $arsip->jumlah_berkas ?? ''))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                        <select name="tingkat_perkembangan" id="tingkat_perkembangan" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" required>
                             <option value="Asli" <?php echo e(old('tingkat_perkembangan', $arsip->tingkat_perkembangan ?? 'Asli') == 'Asli' ? 'selected' : ''); ?>>Asli</option>
                             <option value="Copy" <?php echo e(old('tingkat_perkembangan', $arsip->tingkat_perkembangan ?? '') == 'Copy' ? 'selected' : ''); ?>>Copy</option>
                             <option value="Softcopy" <?php echo e(old('tingkat_perkembangan', $arsip->tingkat_perkembangan ?? '') == 'Softcopy' ? 'selected' : ''); ?>>Softcopy</option>
                        </select>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['id' => 'lokasi_penyimpanan','class' => 'block mt-1 w-full','type' => 'text','name' => 'lokasi_penyimpanan','value' => old('lokasi_penyimpanan', $arsip->lokasi_penyimpanan ?? ''),'required' => true]]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'lokasi_penyimpanan','class' => 'block mt-1 w-full','type' => 'text','name' => 'lokasi_penyimpanan','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('lokasi_penyimpanan', $arsip->lokasi_penyimpanan ?? '')),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                    ...
                    ><?php echo e(old('keterangan_fisik', $arsip->keterangan_fisik ?? '')); ?></textarea>
...
<?php endif; ?>
                    ...
                    <div class="mt-2 flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
                        <label class="flex items-center cursor-pointer">
                            ...
                            <span class="ml-2 text-sm text-gray-700">Upload File (Maks. 5 File @ 5MB)</span>
                        </label>
                        <label class="flex items-center cursor-pointer">
                        ...
                        <button type="button"
                                ...
                                class="sm:ml-4 px-2 py-1 bg-red-100 text-red-700 text-xs font-medium rounded hover:bg-red-200 focus:outline-none"
                                style="display: none;">
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['id' => 'link_eksternal','class' => 'block mt-1 w-full','type' => 'url','name' => 'link_eksternal','value' => old('link_eksternal', $arsip->link_eksternal ?? ''),'placeholder' => 'Contoh: https://docs.google.com/document/d/...']]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'link_eksternal','class' => 'block mt-1 w-full','type' => 'url','name' => 'link_eksternal','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('link_eksternal', $arsip->link_eksternal ?? '')),'placeholder' => 'Contoh: https://docs.google.com/document/d/...']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <fieldset class="border p-4 rounded-md">
            ...
            <div id="uraian-container" class="space-y-4 mt-4">
                <?php
                     $uraianItems = old('uraian_isi'); // 1. Cek old data (jika ada validation error)
 
                     if (!$uraianItems && isset($arsip)) { // 2. Jika TDK ada old data, DAN kita mode edit/duplikat
                         $uraianItems = $arsip->uraianIsiInformasi->toArray();
                     }
                     
                     if (empty($uraianItems)) { // 3. Jika MASIH kosong (mode create, ATAU duplikat/edit tapi arsip aslinya tdk punya uraian)
                         $uraianItems = [['nomor_item' => '1', 'uraian'=>'', 'tanggal'=>'', 'jumlah_lembar'=>'']]; // Default jumlah 1
                     }
                 ?>
                 <?php $__currentLoopData = $uraianItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $uraian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <?php $uraian = (object) $uraian; $uniqueKey = old('uraian_isi') ? $index : ($uraian->id ?? 'new_'.$index); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <button type="button" id="add-uraian-btn" class="mt-4 flex items-center px-4 py-2 bg-gray-800 text-white text-xs rounded-md hover:bg-gray-700 transition">
                <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd" /></svg>
                Tambah Baris Baru
            </button>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const tanggalArsipInput = document.getElementById('tanggal_arsip'); // Ambil input tanggal
        const nomorBerkasInput = document.getElementById('nomor_berkas'); // Ambil input nomor berkas
        let fetchNomorTimeout; // Timer untuk debounce
        
        // --- LOGIKA TOMSELECT DAN JRA (TIDAK BERUBAH) ---
        let tomSelect;
        ...
        // --- LOGIKA FILE INPUT (TIDAK BERUBAH) ---
        ...
        // --- LOGIKA LIVE UPDATE NOMOR BERKAS (TIDAK BERUBAH) ---
        const fetchNextNomorBerkas = () => {
             const tanggalArsip = tanggalArsipInput.value;
             const divisiId = selectedDivisiInput.value;
             if (!tanggalArsip || !divisiId) { return; }
             let apiUrl = '<?php echo e(route("api.get-next-nomor")); ?>';
             let params = { tanggal_arsip: tanggalArsip, divisi_id: divisiId };
             apiUrl = `${apiUrl}?${new URLSearchParams(params).toString()}`;
             nomorBerkasInput.classList.add('opacity-50');
             fetch(apiUrl)
                 .then(response => response.ok ? response.json() : Promise.reject('Network response was not ok'))
                 .then(data => {
                     if (data.next_nomor_berkas) {
                         if (nomorBerkasInput.value === '' || nomorBerkasInput.dataset.lastFetched === nomorBerkasInput.value) {
                             nomorBerkasInput.value = data.next_nomor_berkas;
                             nomorBerkasInput.dataset.lastFetched = data.next_nomor_berkas; 
                         }
                     } else if (data.error) {
                         console.error('API Error:', data.error);
                     }
                 })
                 .catch(error => { console.error('Error fetching nomor berkas:', error); })
                 .finally(() => {
                     nomorBerkasInput.classList.remove('opacity-50');
                 });
         };
         const debounce = (func, delay) => {
             clearTimeout(fetchNomorTimeout);
             fetchNomorTimeout = setTimeout(func, delay);
         };
         tanggalArsipInput.addEventListener('change', () => {
             debounce(fetchNextNomorBerkas, 500); 
         });
         selectedDivisiInput.addEventListener('change', () => {
             debounce(fetchNextNomorBerkas, 500);
         });
         if(nomorBerkasInput.value !== '') {
             nomorBerkasInput.dataset.lastFetched = nomorBerkasInput.value;
         }
        // --- AKHIR LOGIKA LIVE UPDATE ---


        // --- LOGIKA URAIAN ISI (DIPERBAIKI UNTUK RESPONSIVITAS) ---
        ...
        const createNewRow = (data = {}) => {
            ...
            // 9. Ubah grid-cols-6 menjadi grid-cols-1 dan items-end menjadi sm:items-end
        ...
        uraianContainer.addEventListener('click', function(e) {
             ...
             if (duplicateBtn) {
                 ...
                 originalRow.querySelectorAll('input, textarea').forEach(input => {
                     ...
                     // Perbaikan regex untuk ambil key field (uraian, tanggal, dll)
        ...
        // Pastikan nomor item benar saat halaman dimuat (untuk edit/duplikat)
        renumberRows();
    });
</script><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah\resources\views/arsip/_form.blade.php ENDPATH**/ ?>