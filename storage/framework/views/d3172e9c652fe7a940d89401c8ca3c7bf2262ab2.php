...
<div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md">
    ...
    <?php if(session()->has('import_errors')): ?>
        <div class="mt-4 p-4 text-sm text-red-700 bg-red-100 rounded-lg" role="alert">
            ...
            <ul class="mt-2 list-disc list-inside">
                <?php $__currentLoopData = session('import_errors'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $failure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>Baris <?php echo e($failure->row()); ?>: <?php echo e(implode(', ', $failure->errors())); ?> (Nilai: <?php echo e($failure->values()[$failure->attribute()] ?? ''); ?>)</li>
    ...
    <div class="mt-6 flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-2 border-b border-gray-200 pb-4">
        ...
        <button wire:click.prevent="$set('status', '')" class="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium rounded-full w-full sm:w-auto <?php echo e($status == '' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?> transition-colors duration-150">
            Semua Status
            <span class="ml-1.5 rounded-full px-2 py-0.5 text-xs <?php echo e($status == '' ? 'bg-white text-indigo-700' : 'bg-gray-400 text-gray-800'); ?>"><?php echo e($statusCounts['Semua'] ?? 0); ?></span>
        </button>
        
        <button wire:click.prevent="$set('status', 'Aktif')" class="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium rounded-full w-full sm:w-auto <?php echo e($status == 'Aktif' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?> transition-colors duration-150">
            Aktif
            <span class="ml-1.5 rounded-full px-2 py-0.5 text-xs <?php echo e($status == 'Aktif' ? 'bg-white text-indigo-700' : 'bg-gray-400 text-gray-800'); ?>"><?php echo e($statusCounts['Aktif'] ?? 0); ?></span>
        </button>
        
        <button wire:click.prevent="$set('status', 'Inaktif')" class="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium rounded-full w-full sm:w-auto <?php echo e($status == 'Inaktif' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?> transition-colors duration-150">
            Inaktif
            <span class="ml-1.5 rounded-full px-2 py-0.5 text-xs <?php echo e($status == 'Inaktif' ? 'bg-white text-indigo-700' : 'bg-gray-400 text-gray-800'); ?>"><?php echo e($statusCounts['Inaktif'] ?? 0); ?></span>
        </button>
        
        <?php if(Auth::user()->role == 'Admin'): ?>
            <button wire:click.prevent="$set('status', 'Siap Dimusnahkan')" class="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium rounded-full w-full sm:w-auto <?php echo e($status == 'Siap Dimusnahkan' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?> transition-colors duration-150">
                Perlu Dimusnahkan
                <span class="ml-1.5 rounded-full px-2 py-0.5 text-xs <?php echo e($status == 'Siap Dimusnahkan' ? 'bg-white text-indigo-700' : 'bg-gray-400 text-gray-800'); ?>"><?php echo e($statusCounts['Siap Dimusnahkan'] ?? 0); ?></span>
            </button>
            
            <button wire:click.prevent="$set('status', 'Diusulkan Musnah')" class="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium rounded-full w-full sm:w-auto <?php echo e($status == 'Diusulkan Musnah' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?> transition-colors duration-150">
                Diusulkan Musnah
                <span class="ml-1.5 rounded-full px-2 py-0.5 text-xs <?php echo e($status == 'Diusulkan Musnah' ? 'bg-white text-indigo-700' : 'bg-gray-400 text-gray-800'); ?>"><?php echo e($statusCounts['Diusulkan Musnah'] ?? 0); ?></span>
            </button>

            <button wire:click.prevent="$set('status', 'Permanen')" class="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium rounded-full w-full sm:w-auto <?php echo e($status == 'Permanen' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?> transition-colors duration-150">
                Permanen
                <span class="ml-1.5 rounded-full px-2 py-0.5 text-xs <?php echo e($status == 'Permanen' ? 'bg-white text-indigo-700' : 'bg-gray-400 text-gray-800'); ?>"><?php echo e($statusCounts['Permanen'] ?? 0); ?></span>
            </button>
            <button wire:click.prevent="$set('status', 'Musnah')" class="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium rounded-full w-full sm:w-auto <?php echo e($status == 'Musnah' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?> transition-colors duration-150">
                Musnah
                <span class="ml-1.5 rounded-full px-2 py-0.5 text-xs <?php echo e($status == 'Musnah' ? 'bg-white text-indigo-700' : 'bg-gray-400 text-gray-800'); ?>"><?php echo e($statusCounts['Musnah'] ?? 0); ?></span>
            </button>
        
        <?php else: ?>
            <button wire:click.prevent="$set('status', 'Diusulkan Pindah')" class="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium rounded-full w-full sm:w-auto <?php echo e($status == 'Diusulkan Pindah' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?> transition-colors duration-150">
                Diusulkan Pindah
                <span class="ml-1.5 rounded-full px-2 py-0.5 text-xs <?php echo e($status == 'Diusulkan Pindah' ? 'bg-white text-indigo-700' : 'bg-gray-400 text-gray-800'); ?>"><?php echo e($statusCounts['Diusulkan Pindah'] ?? 0); ?></span>
            </button>
            
            <button wire:click.prevent="$set('status', '<?php echo e($arsipDipindahStatus); ?>')" class="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium rounded-full w-full sm:w-auto <?php echo e($status == $arsipDipindahStatus ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?> transition-colors duration-150">
                <?php echo e($arsipDipindahStatus); ?>

                <span class="ml-1.5 rounded-full px-2 py-0.5 text-xs <?php echo e($status == $arsipDipindahStatus ? 'bg-white text-indigo-700' : 'bg-gray-400 text-gray-800'); ?>"><?php echo e($statusCounts[$arsipDipindahStatus] ?? 0); ?></span>
            </button>
        <?php endif; ?>
    </div>
    ...
    <?php if(Auth::user()->role !== 'Admin' && ($statusCounts['Inaktif'] ?? 0) > 0): ?>
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-yellow-800">
                        Bidang anda memiliki <span class="font-bold"><?php echo e($statusCounts['Inaktif']); ?></span> arsip Inaktif yang siap untuk diusulkan pindah ke Tata Usaha.
                    </p>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-2">
            ...
            <?php if(count($selectedArsip) > 0): ?>
                <?php if(Auth::user()->role == 'Admin' && $status === 'Siap Dimusnahkan'): ?>
                    <button type="button" onclick="konfirmasiBuatUsulMusnah(<?php echo e(count($selectedArsip)); ?>)" 
                ...
                <?php elseif(Auth::user()->role != 'Admin' && $status === 'Inaktif'): ?>
                    <button type="button" onclick="konfirmasiBuatUsulPindah(<?php echo e(count($selectedArsip)); ?>)" 
                            class="inline-flex items-center justify-center px-3 py-2 text-sm font-medium
            ...
            <a href="<?php echo e(route('arsip.create')); ?>" 
               class="inline-flex items-center justify-center px-3 py-2 text-sm font-medium
        ...
        <table class="min-w-full divide-y divide-gray-200 table-fixed">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <?php if(Auth::user()->role !== 'Admin' && $status === $arsipDipindahStatus): ?>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $arsips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arsip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="odd:bg-white even:bg-gray-50 align-middle">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900 font-medium"><?php echo e($arsip->klasifikasiSurat?->kode_klasifikasi); ?></td>
                        <td class="px-4 py-3 text-sm text-gray-900 font-medium whitespace-normal break-words"><?php echo e($arsip->uraian_berkas); ?></td>
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-700"><?php echo e(\Carbon\Carbon::parse($arsip->tanggal_arsip)->format('d/m/Y')); ?></td>
                        
                        <?php if(Auth::user()->role !== 'Admin' && $status === $arsipDipindahStatus): ?>
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-700"><?php echo e($arsip->divisi?->nama ?? '-'); ?></td>
                        <?php else: ?>
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-700"><?php echo e($arsip->lokasi_penyimpanan); ?></td>
                        <?php endif; ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    ?>
                    <tr><td colspan="<?php echo e($colspan); ?>" class="px-6 py-4 text-center text-sm text-gray-500">Data tidak ditemukan.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\MAGANG\sistem-kearsipan-bbpom\resources\views/livewire/arsip-table.blade.php ENDPATH**/ ?>