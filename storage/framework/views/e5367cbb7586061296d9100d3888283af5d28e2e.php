...
} elseif ($_instance->childHasBeenRendered('amORt0h')) {
    $componentId = $_instance->getRenderedChildComponentId('amORt0h');
    $componentTag = $_instance->getRenderedChildComponentTagName('amORt0h');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('amORt0h');
} else {
    $response = \Livewire\Livewire::mount('arsip-table');
    $html = $response->html();
    $_instance->logRenderedChild('amORt0h', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php endif; ?><?php /**PATH D:\MAGANG\sistem-kearsipan-bbpom\resources\views/arsip/index.blade.php ENDPATH**/ ?>