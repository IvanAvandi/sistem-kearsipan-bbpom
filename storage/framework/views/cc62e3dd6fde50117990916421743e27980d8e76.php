...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['type' => 'text','wire:model.debounce.300ms' => 'search','placeholder' => 'Cari kode atau nama...','class' => 'pl-10 w-full']]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'text','wire:model.debounce.300ms' => 'search','placeholder' => 'Cari kode atau nama...','class' => 'pl-10 w-full']); ?>
...
<?php endif; ?>
        ...
        <div class="flex flex-col sm:flex-row sm:space-x-2 space-y-2 sm:space-y-0 w-full sm:w-auto">
            ...
            <a href="<?php echo e(route('admin.klasifikasi.create')); ?>" 
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="odd:bg-white even:bg-gray-50 align-middle">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-sm font-semibold text-gray-900"><?php echo e($item->kode_klasifikasi); ?></td>
                        
                        
                        <td class="px-4 py-3 text-sm font-medium text-gray-900 whitespace-normal break-words">
                            <?php echo e($item->nama_klasifikasi); ?>

                        </td>
                        
                        
                        <td class="px-4 py-3 text-sm text-gray-700 text-center">
                            Aktif: <?php echo e($item->masa_aktif); ?> th, Inaktif: <?php echo e($item->masa_inaktif); ?> th
                        </td>
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-center text-sm text-gray-700">
                             ...
                             <span class="inline-flex justify-center items-center px-2.5 py-0.5 text-xs font-medium rounded-full w-36
                                <?php switch($item->klasifikasi_keamanan):
                                    case ('Biasa/Terbuka'): ?> bg-blue-100 text-blue-800 <?php break; ?>
                                    <?php case ('Terbatas'): ?> bg-yellow-100 text-yellow-800 <?php break; ?>
                                    <?php case ('Rahasia'): ?> bg-red-100 text-red-800 <?php break; ?>
                                    <?php case ('Sangat Rahasia'): ?> bg-purple-100 text-purple-800 <?php break; ?>
                                <?php endswitch; ?>"><?php echo e($item->klasifikasi_keamanan); ?>
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-center text-sm font-medium">
                            <div class="flex justify-center items-center space-x-4">
                                <a href="<?php echo e(route('admin.klasifikasi.edit', $item->id)); ?>" title="Edit" class="text-gray-500 hover:text-indigo-600">
                                ...
                                <button wire:click.prevent="delete(<?php echo e($item->id); ?>)" onclick="confirm('Anda yakin ingin menghapus data ini?') || event.stopImmediatePropagation()" title="Hapus" class="text-gray-500 hover:text-red-600">
    ...
    <div x-data="{ show: <?php if ((object) ('showImportModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('showImportModal'->value()); ?>')<?php echo e('showImportModal'->hasModifier('defer') ? '.defer' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('showImportModal'); ?>')<?php endif; ?> }" x-show="show" x-cloak class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
...
</div><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah - Copy\resources\views/livewire/admin/klasifikasi-table.blade.php ENDPATH**/ ?>