            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-yellow-800">
                        Bidang anda memiliki <span class="font-bold"><?php echo e($statusCounts['Inaktif']); ?></span> arsip Inaktif yang siap untuk diusulkan pindah ke bidang Tata Usaha.
                    </p>
                    ...
                    <tr class="odd:bg-white even:bg-gray-50 align-middle">
                        ...
                        <td class="px-4 py-3 text-center text-sm font-medium">
                            <div class="flex justify-center items-center space-x-3">
                                ...
                                <?php
                                    // Tentukan status read-only untuk Arsiparis
                                    $arsiparisReadOnlyStatus = [$arsipDipindahStatus, 'Permanen', 'Musnah'];
                                    
                                    // Tentukan status read-only untuk Admin
                                    $adminReadOnlyStatus = ['Musnah', 'Permanen'];
                                    
                                    // Tentukan status mana yang akan digunakan berdasarkan role
                                    $readOnlyStatuses = (Auth::user()->role === 'Admin') ? $adminReadOnlyStatus : $arsiparisReadOnlyStatus;
                                ?>

                                <?php if( !in_array($status, $readOnlyStatuses) ): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah - Copy\resources\views/livewire/arsip-table.blade.php ENDPATH**/ ?>