<div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Daftar usulan pemindahan arsip dari Bidang lain ke Tata Usaha.</p>
    </div>
        ...
        <table class="min-w-full">
            ...
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="w-1/5 px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Diusulkan Oleh (Bidang)</th>
                    <th scope="col" class="w-40 px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider">Tanggal Diajukan</th>
                    ...
                    <tr class="odd:bg-white even:bg-gray-50 align-middle">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-center text-sm text-gray-500">
                            <?php if($usulan->diajukan_pada): ?>
                                ...
                                <div class="text-xs text-gray-500">(<?php echo e($usulan->diajukan_pada->diffForHumans()); ?>)</div>
                            <?php else: ?>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-center text-sm font-medium">
                            <?php if($usulan->status == 'Diajukan'): ?>
                                <a href="<?php echo e(route('admin.usul-pindah.show', $usulan->id)); ?>"
                                   class="w-24 inline-block text-center px-3 py-1.5 bg-indigo-600 text-white text-xs font-medium rounded-md hover:bg-indigo-700 transition duration-150 ease-in-out">
                                    Tinjau
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('admin.usul-pindah.show', $usulan->id)); ?>"
                                   class="w-24 inline-block text-center px-3 py-1.5 bg-gray-200 text-gray-700 text-xs font-medium rounded-md hover:bg-gray-300 transition duration-150 ease-in-out">
                                    Lihat Detail
                                </a>
                            <?php endif; ?>
                        </td>
...
</div><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah\resources\views/livewire/admin/usulan-pindah-table.blade.php ENDPATH**/ ?>