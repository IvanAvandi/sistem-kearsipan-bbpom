     ...
     <?php $__env->endSlot(); ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="<?php echo e(route('admin.klasifikasi.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah - Copy\resources\views/admin/klasifikasi/create.blade.php ENDPATH**/ ?>