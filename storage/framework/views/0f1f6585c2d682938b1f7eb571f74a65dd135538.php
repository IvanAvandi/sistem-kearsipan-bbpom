...
} elseif ($_instance->childHasBeenRendered('KetDuDi')) {
    $componentId = $_instance->getRenderedChildComponentId('KetDuDi');
    $componentTag = $_instance->getRenderedChildComponentTagName('KetDuDi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KetDuDi');
} else {
    $response = \Livewire\Livewire::mount('usulan-pindah-list');
    $html = $response->html();
    $_instance->logRenderedChild('KetDuDi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php endif; ?><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah - Copy\resources\views/usul-pindah/index.blade.php ENDPATH**/ ?>