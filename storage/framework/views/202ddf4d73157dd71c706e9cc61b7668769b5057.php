<div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md">
    ...
    <div>
        <h2 class="text-2xl font-bold text-gray-800">Manajemen Bentuk Naskah</h2>
        <p class="mt-1 text-base text-gray-500">Kelola jenis-jenis dokumen atau bentuk naskah.</p>
    </div>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['type' => 'text','wire:model.debounce.300ms' => 'search','placeholder' => 'Cari bentuk naskah...','class' => 'pl-10 w-full']]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'text','wire:model.debounce.300ms' => 'search','placeholder' => 'Cari bentuk naskah...','class' => 'pl-10 w-full']); ?>
...
<?php endif; ?>
        ...
        <div class="w-full sm:w-auto">
            <a href="<?php echo e(route('admin.bentuk-naskah.create')); ?>" 
            ...
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-sm font-medium text-gray-700 uppercase tracking-wider">
                        <button wire:click.prevent="sortBy('nama_bentuk_naskah')" class="flex items-center space-x-1">
                            <span>Nama Bentuk Naskah</span>
                            <?php if($sortBy === 'nama_bentuk_naskah'): ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="odd:bg-white even:bg-gray-50 align-middle">
                        ...
                        <td class="px-4 py-3 text-sm font-medium text-gray-900 whitespace-normal break-words">
                            <?php echo e($item->nama_bentuk_naskah); ?>

                        </td>
                        <td class="px-4 py-3 whitespace-nowrap text-center text-sm font-medium">
                            <div class="flex justify-center items-center space-x-4">
                                <a href="<?php echo e(route('admin.bentuk-naskah.edit', $item->id)); ?>" title="Edit" class="text-gray-500 hover:text-indigo-600">
...
</div><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah - Copy\resources\views/livewire/admin/bentuk-naskah-table.blade.php ENDPATH**/ ?>