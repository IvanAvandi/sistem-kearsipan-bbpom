...
} elseif ($_instance->childHasBeenRendered('3jNoDjl')) {
    $componentId = $_instance->getRenderedChildComponentId('3jNoDjl');
    $componentTag = $_instance->getRenderedChildComponentTagName('3jNoDjl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3jNoDjl');
} else {
    $response = \Livewire\Livewire::mount('admin.bentuk-naskah-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('3jNoDjl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php endif; ?><?php /**PATH D:\applications\arsip-bbpom - Fitur Usul Musnah - Divisi - RevisiDemo - Revisi2 - Sibob - usulpindah - Copy\resources\views/admin/bentuk-naskah/index.blade.php ENDPATH**/ ?>