...
} elseif ($_instance->childHasBeenRendered('FX79T2f')) {
    $componentId = $_instance->getRenderedChildComponentId('FX79T2f');
    $componentTag = $_instance->getRenderedChildComponentTagName('FX79T2f');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('FX79T2f');
} else {
    $response = \Livewire\Livewire::mount('admin.link-terkait-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('FX79T2f', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php endif; ?><?php /**PATH D:\MAGANG\sistem-kearsipan-bbpom\resources\views/admin/link-terkait/index.blade.php ENDPATH**/ ?>